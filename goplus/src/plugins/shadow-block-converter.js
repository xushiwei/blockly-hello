// Copy from google/blockly-samples/plugins/shadow-block-converter/src/shadow_block_converter.ts
...
/**
 * Init shadow block converter
 * automatically convert shadow blocks to real blocks whenever the user edits a field on the block
 * @param {Blockly.Workspace} ws Blockly Workspace
 */
export function initShadowBlockConverter(ws) {
